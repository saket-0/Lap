...
const MOCK_USERS = [
    { employeeId: 'EMP-20251029-0001', name: 'Dr. Evelyn Reed', email: 'admin@bims.com', role: 'Admin' },
    { employeeId: 'EMP-20251029-0002', name: 'Marcus Cole', email: 'manager@bims.com', role: 'Inventory Manager' },
    { employeeId: 'EMP-20251029-0003', name: 'Anya Sharma', email: 'auditor@bims.com', role: 'Auditor' }
];
